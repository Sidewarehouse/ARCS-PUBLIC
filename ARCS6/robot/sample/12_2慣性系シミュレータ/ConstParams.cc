...
const std::string ConstParams::ARCS_REVISION("REV.GNRL20060921");	//!< (16文字以内)
...
const std::array<std::string, ConstParams::PLOT_MAX> ConstParams::PLOT_FLABEL = {
	"Current [A]",	// プロット0
	"Load Velocity [rad/s]",	// プロット1
	"Torsion Angle [rad]",	// プロット2
	"Motor Velocity [rad/s]",	// プロット3
	"---------- [-]",	// プロット4
	"---------- [-]",	// プロット5
	"---------- [-]",	// プロット6
	"---------- [-]",	// プロット7
...
> ConstParams::PLOT_VAR_NAMES = {{
	{"iq", "VAR-01", "VAR-02", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット0
	{"wl", "VAR-01", "VAR-02", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット1
	{"ths", "VAR-01", "VAR-02", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット2
	{"wm", "VAR-01", "VAR-02", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット3
