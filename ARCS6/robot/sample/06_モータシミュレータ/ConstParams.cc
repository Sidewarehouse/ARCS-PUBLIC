...
const std::string ConstParams::CTRLNAME("<TITLE: MOTOR SIMULATOR >");		//!< (画面に入る文字数以内)
...
> ConstParams::PLOT_VAR_NAMES = {{
	...
	{"wm", "VAR-01", "VAR-02", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット1
	{"thm", "VAR-01", "VAR-02", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット2
