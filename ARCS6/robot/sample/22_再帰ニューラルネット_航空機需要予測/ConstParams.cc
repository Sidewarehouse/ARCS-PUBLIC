...
const std::string ConstParams::CTRLNAME("<TITLE: RNN Airline Passenger Prediction>");		//!< (画面に入る文字数以内)

// ARCS改訂番号(ARCS本体側システムコード改変時にちゃんと変えること)
const std::string ConstParams::ARCS_REVISION("REV.SMPL21022514");	//!< (16文字以内)
